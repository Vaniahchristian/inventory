...
import { exportProductsToExcel, exportProductsToPdf, parseExcelFile } from '@/lib/export'
...
const UNITS = ['pcs', 'kg', 'g', 'L', 'mL', 'box', 'bag', 'roll', 'pair', 'set']
...
function Field({
  ...
  return (
    <div>
      <Label className="text-xs text-slate-600 mb-1 block">{label}{required && ' *'}</Label>
      <Input
        name={name}
        type={type}
